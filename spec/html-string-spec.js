(function() {
  ...
  quotes = {
    Gates: '<b><q data-example>We all</q></b><q data-example> need people who will give us feedback. That\'s how we improve.</q>',
  ...
  describe('HTMLString.String()', function() {
    ...
    return it('should parse and render a string (HTML)', function() {
      ...
      return expect(string.html()).toBe(quotes.Turing);
    });
  });
